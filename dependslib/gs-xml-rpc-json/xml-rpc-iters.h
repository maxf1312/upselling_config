...
class value_const_iterator : public std::iterator<std::bidirectional_iterator_tag,struct value>
{
 ...
 public:
  ...
  {
    if (_value->__type == SOAP_TYPE__struct)
      return static_cast<int>(std::distance(((_struct*)_value->ref)->member, _member));
    if (_value->__type == SOAP_TYPE__array)
      return _index;
    return 0;
  }
...
class _array_const_iterator
{
 ...
 public:
  ...
  int                           index() const      { return static_cast<int>(std::distance(_start, _value));  } ///< get array index
...
class params_const_iterator
{
 ...
 public:
  ...
  int                           index() const      { return static_cast<int>(std::distance(_start, _param)); } ///< get parameter index
