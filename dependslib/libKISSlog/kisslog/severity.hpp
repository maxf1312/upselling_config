...
namespace kisslog {
  ...
  namespace severity {
    enum Severity {// Numerical codes are from RFC-5424
        EMERG=0, ALERT=1, CRIT=2, ERR=3, WARNING=4, NOTICE=5, INFO=6, DEBUG_=7
    };
    ...
    template<> inline std::basic_string<char> asPrefix<DEBUG_,char>(){ return "DEBUG"; }
    ...
    template<> inline std::basic_string<wchar_t> asPrefix<DEBUG_,wchar_t>(){ return L"DEBUG"; }
  }
}
#endif
