...
* 'configure.py --verbose --disable-shared --no-autoload --enable-modules=idea,hex,modes,ofb,ctr,filters --amalgamation'
*
* Target
...
#define BOTAN_VERSION_VC_REVISION "git:afe8d379eb10ebf2fb611a9c1ef3ed32caedb74c"
